 ...
 * อัปเดตล่าสุด: 2026-09-13T15:21:38.045Z
 * 
...
function seedInitialData(ss) {
  ...
  var defaultSettings = [
    ...
    ["rules_title", "ระเบียบและข้อปฏิบัติการใช้ห้องซ้อมดนตรี ชมรมดนตรี วทก.", "หัวข้อระเบียบและข้อปฏิบัติที่ส่วนท้ายเว็บ"],
    ["rules_text", "การเช็คอิน: กรุณากดเช็คอินหน้าเว็บตั้งแต่ก่อนเริ่มเวลา 15 นาที จนถึงไม่เกิน 30 นาทีหลังเวลาเริ่ม (หากไม่เช็คอิน ระบบจะตัดสิทธิ์ No-show และปล่อยห้องให้ผู้อื่นทันที)\nการดูแลอุปกรณ์: ห้ามนำอาหารและเครื่องดื่ม (ยกเว้นน้ำเปล่ามีฝาปิด) เข้าในห้องซ้อม ปรับแอมป์และเสียงดนตรีในระดับที่เหมาะสม\nการตรงต่อเวลา: ซ้อมเสร็จกรุณากดเช็คเอาต์หน้าเว็บทันที และออกจากห้องตรงเวลา เพื่อความสะดวกของคิวถัดไป\nความปลอดภัย: ปิดสวิตช์เครื่องใช้ไฟฟ้า แอมป์ และเครื่องปรับอากาศทุกครั้งก่อนออกจากห้อง", "รายการระเบียบและข้อปฏิบัติ (แยกบรรทัด)"],
    ["contact_title", "ติดต่อและสอบถามข้อมูล", "หัวข้อกล่องข้อมูลติดต่อ"],
    ["contact_location", "ชมรมดนตรี อาคารกิจกรรมนักศึกษา ชั้น 2 วทก.", "สถานที่ตั้งห้องซ้อมดนตรี"],
    ["footer_copyright", "ชมรมดนตรี วิทยาลัยเทคโนโลยีทางการแพทย์และสาธารณสุข กาญจนาภิเษก (วทก.)", "ข้อความลิขสิทธิ์แถบล่างสุด"],
    ["footer_tagline", "พัฒนาเพื่อส่งเสริมกิจกรรมนักศึกษา", "สโลแกนสนับสนุนมุมขวาล่าง"]
  ];
...
function getSettingsMap() {
  var map = {
    ...
    announcement_text: "",
    contact_info: "",
    rules_title: "ระเบียบและข้อปฏิบัติการใช้ห้องซ้อมดนตรี ชมรมดนตรี วทก.",
    rules_text: "การเช็คอิน: กรุณากดเช็คอินหน้าเว็บตั้งแต่ก่อนเริ่มเวลา 15 นาที จนถึงไม่เกิน 30 นาทีหลังเวลาเริ่ม (หากไม่เช็คอิน ระบบจะตัดสิทธิ์ No-show และปล่อยห้องให้ผู้อื่นทันที)\nการดูแลอุปกรณ์: ห้ามนำอาหารและเครื่องดื่ม (ยกเว้นน้ำเปล่ามีฝาปิด) เข้าในห้องซ้อม ปรับแอมป์และเสียงดนตรีในระดับที่เหมาะสม\nการตรงต่อเวลา: ซ้อมเสร็จกรุณากดเช็คเอาต์หน้าเว็บทันที และออกจากห้องตรงเวลา เพื่อความสะดวกของคิวถัดไป\nความปลอดภัย: ปิดสวิตช์เครื่องใช้ไฟฟ้า แอมป์ และเครื่องปรับอากาศทุกครั้งก่อนออกจากห้อง",
    contact_title: "ติดต่อและสอบถามข้อมูล",
    contact_location: "ชมรมดนตรี อาคารกิจกรรมนักศึกษา ชั้น 2 วทก.",
    footer_copyright: "ชมรมดนตรี วิทยาลัยเทคโนโลยีทางการแพทย์และสาธารณสุข กาญจนาภิเษก (วทก.)",
    footer_tagline: "พัฒนาเพื่อส่งเสริมกิจกรรมนักศึกษา"
  };
  try {
